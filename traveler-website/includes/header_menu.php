...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Nusantara Trip</a>
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#jawa" class="dropdown-item">Pulau Jawa</a>
                                   <a href="products.php#sumatra" class="dropdown-item">Pulau Sumatra</a>
                                   <a href="products.php#sulawesi" class="dropdown-item">Pulau Sulawesi</a>
                                   <a href="products.php#papua" class="dropdown-item">Pulau Papua</a>
                               </div>
                       ...
                       if (isset($_SESSION['email'])) {
                        ?>
                       <li class="nav-item"><a href="cart.php" class="nav-link">Booking List</a></li>
                       <?php
                          } 
                    ?>
                    </ul>
