...
(1, 'Gunung Semeru', 700000),
(2, 'Gunung Lawu',  850000),
(3, 'Gunung Argopuro', 950000),
(4, 'Gunung Ciremai', 600000),
(5, 'Gunung Kerinci', 1200000),
(6, 'Gunung Dempo', 1100000),
(7, 'Gunung Marapi', 1150000),
(8, 'Gunung Singgalang', 1250000),
(9, 'Gunung Latimojong', 1500000),
(10, 'Gunung Balease', 1600000),
(11, 'Gunung Gandangdewata', 1700000),
(12, 'Gunung Rantekombola', 1800000),
(13, 'Gunung Jayawijaya', 2500000),
(14, 'Gunung Trikora', 2400000),
(15, 'Gunung Pililmsit', 2450000),
(16, 'Gunung Yaramamafaka', 23500000);
...
ALTER TABLE `users_products`
  ...
  ADD CONSTRAINT `users_products_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `destination` (`id`);
COMMIT;
